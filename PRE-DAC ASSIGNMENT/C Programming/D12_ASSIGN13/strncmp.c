// strcmp()  stands for string compare with specific number of characters. 
// This function is used to compare value of one string value with another string value 
// but it would compare specific number of characters as provided by the programmer or user.
